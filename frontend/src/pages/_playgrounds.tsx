	...
	return (
		<div className="min-h-screen bg-base-background p-8">
			<div className="max-w-4xl mx-auto">
				<h1 className="text-2xl font-bold mb-8">Component Playgrounds</h1>

				{/* Atoms Section */}
				<section className="space-y-8">
					<h2 className="text-2xl font-semibold">Atoms</h2>

					{/* Progress Checker */}
					<div className="bg-white p-6 rounded-lg shadow-sm">
						<h3 className="text-lg font-semibold mb-4">Progress Checker</h3>
								...
								<div className="space-y-4 max-w-xs">
									...
									<div>
										...
										<Dropdown
											...
											onChange={(value) =>
												setSelectedAuthority(value as string)
											}
											label="권한"
										/>
									</div>
					...
					{/* Duty Badges */}
					<div className="bg-white p-6 rounded-lg shadow-sm">
						<h3 className="text-lg font-semibold mb-4">Duty Badges</h3>
						<div className="space-y-6">
							{/* Extra Small */}
							<div>
								<h4 className="text-sm font-medium text-base-muted mb-4">
					...
					{/* Ward Code Input */}
					<div className="bg-white p-6 rounded-lg shadow-sm">
						<h3 className="text-lg font-semibold mb-4">Ward Code Input</h3>
						<div className="space-y-6">
							{/* Default */}
							<div>
								<h4 className="text-sm font-medium text-base-muted mb-4">
				...
				<section className="mt-8">
					<div className="bg-white p-6 rounded-lg shadow-sm">
						<h2 className="text-lg font-semibold mb-4">Font Weight Showcase</h2>
						<div className="space-y-4">
							<p className="text-lg font-black">
								Black (900) - 가장 두꺼운 텍스트
							</p>
